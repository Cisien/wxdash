...
Plans:
- [x] 07-01-PLAN.md -- Calm sample tracking in wind ring buffer, recent-average speed per bin (TDD)
- [x] 07-02-PLAN.md -- CompassRose calm dot, recent-average bar colors, color function unification, visual verification
...
**Plans**: 0 plans (direct change — single line in ForecastPanel.qml)
